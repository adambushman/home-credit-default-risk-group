...
A suport vector machine could be a good approach due to many features, capturing some non-linear relationships, and robustness to overfitting. It's also pretty ideal for our binary classification use-case.
